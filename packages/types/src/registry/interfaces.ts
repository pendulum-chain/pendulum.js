...
import type { SpacewalkPrimitivesCurrencyId, SpacewalkPrimitivesForeignCurrencyId, SpacewalkPrimitivesVaultCurrencyPair, SpacewalkPrimitivesVaultId } from '@pendulum-chain/types/interfaces/vaultRegistry';
